		...
		<div class="cls-content">
			<div class="cls-content-sm panel">
				<div class="panel-body">
					...
					<form action="http://www.themeon.net/nifty/wb/v2.1/pages-login.html">
			...
			<div class="pad-ver">
				<a href="pages-login.php" class="btn-link mar-rgt">Back to Login</a>
			</div>
		</div>
		<!--===================================================-->
...
<!-- Mirrored from www.themeon.net/nifty/wb/v2.1/pages-password-reminder.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jan 2015 17:04:27 GMT -->
</html>

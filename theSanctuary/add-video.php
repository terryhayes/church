	...
	<div id="container" class="effect mainnav-lg">
		...
		<div class="boxed">
			...
			<div id="content-container">
				...
				<!--Page Title-->
				<div id="page-title">
					<h1 class="page-header text-overflow">Video</h1>
				</div>
				<!--End page title-->
								...
								<form class="form-horizontal" name="pledge"method="post" action="" enctype="multipart/form-data">
									<div class="panel-body">
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="text"  autocomplete="off" placeholder="video Title" id="title" name='spot_title' class="form-control" style='border:1px solid black;'  required>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="name">Description</label>
											<div class="col-sm-9">
												<textarea name='spot_descibe' placeholder='Short Description of video' class="form-control" rows="5" style='border:1px solid black;'></textarea>
											</div>
											 
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label" for="name">Add Video</label>
											<div class="col-sm-9">

<?php
    ...
    if(isset($_POST['send_msg'])){
        ...
        $sql = "INSERT INTO `prayer`(`sender`, `email`, `phone`,`title`, `message`, `created_on`, `is_delete`) VALUES (:name,:mail,:phone,:title,:message,NOW(),'0')";
...
<p class="lead">Send A Prayer Request</p>
</div>
</div>
...
<div class="col-md-6 has-margin-bottom">
    ...
    <form id="phpcontactform" role="form" method="post" action="">
        ...
        <div class="form-group">
        <label>Topic</label>
        <input type="text" class="form-control" name="title" id="name" placeholder='title of prayer'>
        </div>
        <div class="form-group">
        <label>Message</label>
